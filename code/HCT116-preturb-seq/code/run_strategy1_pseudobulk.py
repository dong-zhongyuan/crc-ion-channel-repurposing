...
OUT_FIG = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'result', 'figures')
os.makedirs(OUT_FIG, exist_ok=True)
OUT_TBL = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'result', 'tables')
...
for ko, _ in PAIRS:
    if ko not in deg_tables:
        fpath = os.path.join(OUT_TBL, f'deg_{ko}.csv')  # pre-computed DEG table (optional)
